      ...
      <div>
        ...
        <p>
          ...
          <span>
            ...
            tempore! Atque deleniti et fuga, impedit, incidunt iure magnam
            maiores minima modi necessitatibus non possimus provident, saepe
            sapiente voluptate.
          </span>
          <span>
            Animi blanditiis distinctio ex harum in, magnam nam odio repellat
            ut. Ab, accusantium, ad commodi culpa debitis eveniet illo ipsam
            molestias neque omnis possimus repellat sed soluta suscipit
          ...
          <span>
            ...
            saepe, sapiente sint soluta voluptatibus? Adipisci aliquid
            blanditiis impedit nulla repellat sed totam velit voluptates?
          </span>
          <span>
            Architecto aspernatur autem beatae consectetur dignissimos enim iste
            iusto libero nostrum nulla perspiciatis possimus provident
            quibusdam, soluta tempore totam ullam vero voluptate. Consectetur
            debitis harum hic perspiciatis quod veniam voluptatum.
          </span>
        </p>
      </div>
    );
